...
mod test_widget_gauge {
    ...
    use ctrl_sys_widgets::widgets::gauge::{render_inner_connected, render_inner_disconnected};
    use ctrl_sys_widgets::widgets::{render_gauge, MAJOR_ALARM_SVG, MINOR_ALARM_SVG};
